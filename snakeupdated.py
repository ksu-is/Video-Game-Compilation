...
dirs = 0;score = 0;applepos = (random.randint(0, 590), random.randint(0, 590))
...
t=f.render("Welcome to Snake", True, (255,185,15))
v=f.render("Don't hit the walls or yourself.", True, (255,185,15))
w=f.render("The game will begin in 5 seconds get ready.", True, (255,185,15))
s.blit(t, (10, 270))
s.blit(v, (10, 290))
s.blit(w, (10, 330))
pygame.display.update()
